            ...
            <div className="text-center max-w-4xl mx-auto">
              <div className="animate-fade-in">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                  <Button size="lg" className="bg-gradient-primary hover:opacity-90 text-white px-8 py-3 text-lg shadow-elegant">
        ...
        <section className="container mx-auto px-4 py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {categories.map((category, index) => (
              <Card key={category.id} className={`group hover:shadow-elegant transition-all duration-300 transform hover:-translate-y-2 animate-fade-in shadow-soft gradient-card border-0 ${index === 1 ? 'md:scale-105' : ''}`}>
                <CardContent className="p-8 text-center relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    ...
                    <h3 className="text-2xl font-bold mb-4 text-foreground">{category.name}</h3>
        ...
        <section className="container mx-auto px-4 py-16 text-center">
          <div className="bg-gradient-primary rounded-3xl p-12 text-white relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <Button size="lg" variant="secondary" className="bg-white text-primary hover:bg-white/90 px-8 py-3 text-lg shadow-elegant">
                <MessageCircle className="h-5 w-5 mr-2" />
